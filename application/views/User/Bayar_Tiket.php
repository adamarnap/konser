<div class="header-body text-center mb-7">
        ...
        <div class="row justify-content-center">
            <div class=" col-lg-6 col-md-8 mt-5 px-5">
              <span id="event"><h1 class="text-black"><b>KONFIRMASI PEMBAYARAN<b></h1></span>
              <h2 class="text-lead text-dark"><b>Segera lakukan pembayaran, dan datangi konser sesuai Jadwalnya !</b></h2>
        </div>
        </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-warning my-4">Bayar Tiket</button>               
                  </div>   
                    </form> 
