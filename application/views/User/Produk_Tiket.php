...
<!-- Light table -->
            ...
            <div class="card-header border-3">
              <center> <h1 class="mb-0 text-black" style = "text-shadow: 3px 2px 5px grey;" ><b>Menu Produk Tiket Toko "<?php echo $nama_toko -> nama_toko; ?>"</b></h1></center>
              <a href="<?php echo site_url('User/Tambah_Tiket/'.$val['id_toko']);?>" class="btn btn-neutral btn-icon" >
                  
                  <span class="">TAMBAH TIKET KONSER</span></a>
      ...
      <!--  <th scope="col">Aksi Hapus</th> -->
        ...
        <?php $no =1; foreach($tiket as $val) { ?>
            ...
            <tr>
             ...
             <!--
               <td>
                    <a href="<?php echo site_url('User/Getid_Tiket/'. $val['id_tiket']. '/'. $val['id_toko']); ?>" class="btn btn-warning"> Edit </a>
                </td>
              -->
                <td>
                    <a href="<?php echo site_url('User/Hapus_Tiket/'. $val['id_tiket']. '/'. $val['id_toko']); ?>" class="btn btn-danger"> Hapus </a>
                </td>
