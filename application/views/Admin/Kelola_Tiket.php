...
<!-- Light table -->
            ...
            <div class="card-header border-3">
              <center> <h1 class="mb-0 text-black" style = "text-shadow: 3px 2px 5px grey;" ><b>Kelola Produk Tiket Konser</b></h1></center>
            </div>
      ...
      <!--  <th scope="col">Aksi Hapus</th> -->
        ...
        <?php $no =1; foreach($tiket as $val) { ?>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo site_url('Admin/Hapus_Tiket/'. $val->id_tiket); ?>" class="btn btn-danger"> Hapus </a>
                </td>
